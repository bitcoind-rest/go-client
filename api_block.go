...
/* 
BlockApiService Get block by hash.
...
@return Block
*/
func (a *BlockApiService) RestBlockExtended(ctx context.Context, blockHash string) (Block, *http.Response, error) {
	var (
...
@return Block
*/
func (a *BlockApiService) RestBlockNotxdetails(ctx context.Context, blockHash string, format string) (Block, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
